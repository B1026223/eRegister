	...
	<body>
		...
		<div id="show-regEntry" class="content scaffold-show" role="main">
			...
			<ol class="property-list regEntry">
				...
				<g:if test="${regEntryInstance?.sheet}">
				<li class="fieldcontain">
					<span id="sheet-label" class="property-label"><g:message code="regEntry.sheet.label" default="Sheet" /></span>
					
						<span class="property-value" aria-labelledby="sheet-label"><g:link controller="regSheet" action="show" id="${regEntryInstance?.sheet?.id}">${regEntryInstance?.sheet?.encodeAsHTML()}</g:link></span>
