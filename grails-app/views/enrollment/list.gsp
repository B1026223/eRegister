			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="enrollment.enroll_course.label" default="Enrollcourse" /></th>
					
						<th><g:message code="enrollment.enroll_student.label" default="Enrollstudent" /></th>
				...
				<g:each in="${enrollmentInstanceList}" status="i" var="enrollmentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${enrollmentInstance.id}">${fieldValue(bean: enrollmentInstance, field: "enroll_course")}</g:link></td>
					
						<td>${fieldValue(bean: enrollmentInstance, field: "enroll_student")}</td>
